            ...
            <StyledCalendar bottom={position[1] === "bottom"} left={position[0] === "left"}>
                <Left>
                    <CalendarHead>
                        ...
                        <IconGroup>
                            <FiChevronLeft onClick={() => swipe('prev')}>Prev</FiChevronLeft>
                            <FiChevronRight onClick={() => swipe('next')}>Next</FiChevronRight>
                        </IconGroup>
                    ...
                    {viewMonth ? 
                        <>
                            <CalendarHead>
                                ...
                                <IconGroup>
                                    <FiChevronLeft onClick={() => swipeYear('prev')}>Prev</FiChevronLeft>
                                    <FiChevronRight onClick={() => swipeYear('next')}>Next</FiChevronRight>
                                </IconGroup>
                            </CalendarHead>
                            <StyledCalendarBar>
                                {months.map(month => 
