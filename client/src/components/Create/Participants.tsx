...
interface ParticipantsProps extends Pick<IRequestInput, "advisors" | "approvers" | "observators"> {
    ...
    return users ? (
        <Flex direction="column">
            <FormControl
                label="Advisor List"
                error={
                    advisors.some(advisor => approvers.concat(observators).includes(advisor))
                        ? "Duplicate"
                        : errors.advisors
                }
            >
