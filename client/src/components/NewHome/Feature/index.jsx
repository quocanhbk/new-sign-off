...
const features = [
    {type: "Functionality", name: "System File", sub: "You can select file from the system and fill them out easily!"},
    ...
    {type: "User Experience", name: "Fast And Performant", sub: "Powered by modern web app technology, we ensure the best experience to users!"},
    {type: "User Experience", name: "Dark Theme", sub: "Easy on the eyes! But you can switch to light theme if you like!"}
]
