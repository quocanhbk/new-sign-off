...
const types = [
    ...
    {id: "REQUEST_NOT_SELECTED", text: "Select request to view", sub: "No request is selected", Icon: BsInfoCircle, color: "secondary"}
]
...
Placeholder.propTypes = {
    type: pt.oneOf(["NOT_FOUND", "PROCEDURE_NOT_SELECTED", "FORM_NOT_SELECTED", "REQUEST_NOT_SELECTED"])
}
