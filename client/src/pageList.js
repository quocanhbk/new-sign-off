...
const pageList = [
    ...
    {icon: <BsFileEarmarkPlus size="24px"/>, text: "Create Document", path: "/create", link: "/create", comp: <CreatePage mode="create"/>},
    {icon: <BsFileEarmarkPlus size="24px"/>, text: "Create Document", path: "/draft/:id", link: "/draft", comp: <CreatePage mode="draft"/>, notVisible: true},
    {icon: <BsFileEarmarkPlus size="24px"/>, text: "Create Document", path: "/revise/:id", link: "/revise", comp: <CreatePage mode="revise"/>, notVisible: true},
