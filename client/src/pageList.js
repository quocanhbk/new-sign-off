...
const pageList = [
    ...
    {icon: <BsHouse size="24px"/>, text: "Home", path: "/", link: "/", comp: <NewHomePage/>},
    {icon: <BsSearch size="24px"/>, text: "Search Document", path: "/search/*", link: "/search", comp: <SearchPage/>},
    {icon: <BsFileEarmarkPlus size="24px"/>, text: "Create Document", path: "/create", link: "/create", comp: <CreatePage mode="create"/>, noMobile: true},
    {icon: <BsFileEarmarkPlus size="24px"/>, text: "Create Document", path: "/draft/:id", link: "/draft", comp: <CreatePage mode="draft"/>, notVisible: true, noMobile: true},
